...
<head>
    ...
    <link rel="stylesheet" href="{{ Zhiyi\Component\ZhiyiPlus\PlusComponentIm\asset('bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ Zhiyi\Component\ZhiyiPlus\PlusComponentIm\asset('app.css') }}">
